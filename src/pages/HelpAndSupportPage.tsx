				...
				<div className="flex sm:flex-row flex-col gap-[30px] w-full">
					<div className="flex flex-col items-start sm:gap-6 gap-4 relative self-stretch w-full sm:border border-border dark:border-borderDark sm:p-[23px] rounded-2xl">
						<div className="flex sm:items-start items-center sm:gap-6 gap-4 relative self-stretch w-full">
							...
							<div className="flex flex-col items-start sm:gap-1.5 gap-0.5 relative flex-1 grow">
					...
					<div className="hidden sm:flex flex-col items-center sm:gap-6 gap-4 relative self-stretch w-full border border-border dark:border-borderDark sm:p-[23px] p-[15px] rounded-2xl">
						<img src="/assets/images/customer-service-agent-1.svg" className="sm:h-[118px] h-[60px]" />
						<div className="flex flex-col gap-2 items-center text-center">
							<div className="[font-family:'Satoshi',Helvetica] font-bold sm:text-2xl text-lg leading-[100%] tracking-[0]">
								Get help
							</div>
