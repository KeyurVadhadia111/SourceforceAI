...
export const GetHelp: React.FC<{ className?: string }> = ({ className }) => {
	return (
		<div
			className={`hidden sm:flex flex-col items-center sm:gap-6 gap-4 relative self-stretch w-full border border-border dark:border-borderDark sm:p-[23px] p-[15px] rounded-2xl ${className}`}>
