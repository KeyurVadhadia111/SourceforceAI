				...
				<div className="flex flex-col items-start justify-center sm:gap-6 gap-4 p-6 relative w-full sm:-mt-px sm:-mb-px sm:border-t sm:border-b border-border dark:border-borderDark">
					...
					<div className="flex w-full sm:flex-row flex-col items-start gap-8 relative ">
						<div className="flex flex-col items-start sm:gap-5 gap-4 relative flex-1 grow w-full">
							<div className="relative w-fit [font-family:'Satoshi',Helvetica] font-bold text-text dark:text-textDark text-xl tracking-[0] leading-[150%] whitespace-nowrap">
								Send us a Message
							</div>

							<div className="flex flex-col items-start sm:gap-8 gap-4 sm:p-[30px] p-4 relative self-stretch w-full  bg-tgc dark:bg-tgcDark sm:rounded-3xl rounded-2xl">
								<div className="flex flex-col items-start sm:gap-8 gap-5 relative self-stretch w-full">
									<div className="flex flex-col items-start sm:gap-6 gap-4 relative self-stretch w-full ">
										<Input
											...
											postIcon={isDark ? "user-dark" : "user"}
											className="sm:!text-sm !text-xs sm:!pl-6 sm:!pr-2 sm:!pt-5 sm:!pb-5 !pl-4 !pt-2 !pb-2 !pr-1"
										/>
										<Input
											placeholder="Email"
											postIcon={isDark ? "envelope-dark" : "envelope"}
											className="sm:!text-sm !text-xs sm:!pl-6 sm:!pr-2 sm:!pt-5 sm:!pb-5 !pl-4 !pt-2 !pb-2 !pr-1"
										/>
										<Input
											placeholder="Phone Number"
											postIcon={isDark ? "phone-dark" : "phone"}
											className="sm:!text-sm !text-xs sm:!pl-6 sm:!pr-2 sm:!pt-5 sm:!pb-5 !pl-4 !pt-2 !pb-2 !pr-1"
										/>
										<textarea
											name="message"
						...
						<div className="flex flex-col items-start gap-5 relative flex-1 grow">
							<div className="relative w-fit [font-family:'Satoshi',Helvetica] font-bold text-text dark:text-textDark text-xl tracking-[0] leading-[30px] whitespace-nowrap">
								Contact Information
							</div>

							<div className="flex flex-col items-start gap-8 relative self-stretch w-full ">
								<div className="flex items-start sm:gap-6 gap-3 sm:px-[23px] sm:py-[29px] p-[15px] relative self-stretch w-full  sm:rounded-3xl rounded-2xl border border-border dark:border-borderDark">
									<div className="relative sm:w-14 sm:h-14 w-9 h-9 bg-fgc dark:bg-fgcDarkcircle/20 rounded-[28px] flex justify-center items-center">
										<Icon className="sm:w-[19px] sm:h-[19px] w-4 h-4" icon={isDark ? "phone-dark" : "phone"} />
									</div>
								...
								<div className="flex items-start sm:gap-6 gap-3 sm:px-[23px] sm:py-[29px] p-[15px] relative self-stretch w-full  sm:rounded-3xl rounded-2xl border border-border dark:border-borderDark sm:mt-px">
									<div className="relative sm:w-14 sm:h-14 w-9 h-9 bg-fgc dark:bg-fgcDarkcircle/20 rounded-[28px] flex justify-center items-center">
										<Icon className="sm:w-[19px] sm:h-[19px] w-4 h-4" icon={isDark ? "envelope-dark" : "envelope"} />
									</div>
								...
								<div className="flex sm:items-center sm:gap-6 gap-3 sm:px-[23px] sm:py-[29px] p-[15px] relative self-stretch w-full  sm:rounded-3xl rounded-2xl border border-border dark:border-borderDark">
									<div className="relative sm:w-14 sm:h-14 w-9 h-9 bg-fgc dark:bg-fgcDarkcircle/20 rounded-[28px] flex justify-center items-center">
										<Icon className="sm:w-[19px] sm:h-[19px] w-4 h-4" icon={isDark ? "location-dark" : "location"} />
									</div>
									...
									<div className="flex flex-col items-start sm:gap-1.5 gap-1 relative flex-1 grow">
										...
										<p className="relative w-fit [font-family:'Satoshi',Helvetica] font-medium text-textSecondary dark:text-textSecondaryDark sm:text-base text-xs tracking-[0] leading-[150%] sm:max-w-[311px]">
