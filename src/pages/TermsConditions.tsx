		...
		<div>
			<SimpleBar className="sm:h-[calc(100dvh-104px)] h-[calc(100dvh-56px)] w-full">
				<div className="flex flex-col items-start justify-center sm:gap-6 gap-4 p-6 sm:pt-[23px] sm:pb-[23px] relative w-full flex-[0_0_auto] sm:border-t sm:border-b border-border">
					<div className="relative w-fit font-bold text-text sm:text-2xl text-lg tracking-[0] leading-[150%] whitespace-nowrap">
						Legal Notices
					</div>
					<div className="flex flex-col items-start sm:gap-5 gap-4 sm:px-2 py-0 relative flex-[0_0_auto] ">
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto] ">
							<p className="relative self-stretch font-bold text-text sm:text-base text-sm tracking-[0] leading-[150%] -mt-px sm:mt-0">
								Last Updated: 02 June 2025
							</p>

							<p className="relative self-stretch font-medium text-textSecondary sm:text-sm text-xs tracking-[0] leading-[150%] mt-0.5 sm:mt-0 ">
						...
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto] -mt-px sm:-mt-0">
							<div className="flex items-center gap-2 relative self-stretch font-bold text-text sm:text-base text-sm tracking-[0] leading-[150%] pl-[4px]">
								<span>1.</span>
								<span>Acceptance of Terms</span>
							</div>

							<p className="relative self-stretch font-medium text-textSecondary sm:text-sm text-xs tracking-[0] leading-[150%] mt-px sm:mt-0">
						...
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto]">
							<div className="relative self-stretch font-bold text-text sm:text-base text-sm tracking-[0] leading-[150%] -mt-0.5 sm:mt-0 pl-[4px]">
								2. Use of Platform
							</div>

							<div className="flex flex-col items-start sm:gap-2.5 gap-2 relative self-stretch w-full flex-[0_0_auto] sm:-ml-px">
								<p className="relative self-stretch font-bold text-text sm:text-sm text-xs tracking-[0] leading-[150%] mt-px sm:mt-0">
								...
								<div className="flex flex-col w-[308px] items-start sm:gap-2 gap-1.5 relative flex-[0_0_auto] mt-px sm:-mt-0">
									<div className="inline-flex items-center sm:gap-2.5 gap-1.5 relative flex-[0_0_auto]">
										...
										<div className="relative w-fit font-medium text-textSecondary sm:text-sm text-xs tracking-[0] leading-[150%] whitespace-nowrap">
							...
							<div className="flex flex-col items-start sm:gap-2.5 gap-2 relative self-stretch w-full flex-[0_0_auto] -mt-px sm:-mt-0 sm:-ml-px">
								<div className="relative self-stretch font-bold text-text sm:text-sm text-xs tracking-[0] leading-[150%]">
									You must not:
								</div>
								...
								<div className="flex flex-col w-[285px] items-start sm:gap-2 gap-1.5 relative flex-[0_0_auto] mt-px sm:-mt-0">
									<div className="flex items-center sm:gap-2.5 gap-1.5 relative self-stretch w-full flex-[0_0_auto]">
										...
										<p className="relative w-fit font-medium text-textSecondary sm:text-sm text-xs tracking-[0] leading-[150%] whitespace-nowrap">
						...
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto] -mt-0.5 sm:-mt-0">
							<div className="relative self-stretch font-bold text-text sm:text-base text-sm tracking-[0] leading-[150%] pl-[4px] -bg-conic-0">
						...
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto] -mt-0.5 sm:-mt-0">
							<div className="relative self-stretch font-bold text-text sm:text-base text-sm tracking-[0] leading-[150%] pl-[3.5px]">
						...
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto] -mt-0.5 sm:-mt-0">
							<div className="relative self-stretch font-bold text-text sm:text-base text-sm tracking-[0] leading-[150%] pl-[4px]">
						...
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto]">
							...
							<p className="relative self-stretch font-medium text-textSecondary sm:text-sm text-xs tracking-[0] leading-[150%]">
						...
						<div className="flex flex-col items-start sm:gap-3 gap-2 relative self-stretch w-full flex-[0_0_auto] -mt-0.5 sm:-mt-0">
							<div className="flex items-center gap-1.5 relative self-stretch font-bold text-text sm:text-base text-sm tracking-[0] leading-[150%] pl-[4px]">
								<span>7.</span>
