...
const FilterTag: React.FC<FilterTagProps> = ({ id, label, onRemove }) => {
	return (
		<div className="inline-flex items-center justify-center gap-1 sm:gap-1.5 sm:px-[19px] px-[11px] sm:py-[9px] py-[7px] relative rounded-[52px] border border-border">
			...
			<button
				...
				<Icon className="relative h-full w-full" icon="x-mark" />
			</button>
		</div>
	);
};
